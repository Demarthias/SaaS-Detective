...
async function sendTrialReminderEmail(env, email, key, expiresAt) {
  ...
  <p style="color:#475569;font-size:14px;margin:0 0 24px;">You've been scanning sites with access to all 800+ tool signatures. In ${timeLabel} your account reverts to the free plan (50 signatures).</p>
