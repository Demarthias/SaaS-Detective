...
const signatures = [
  ...
  {id:"convertkit",name:"ConvertKit",category:"Email",patterns:["convertkit.com","f.convertkit.com","ck.page","cdn.kit.com"],globalVar:[],description:"Email marketing platform for creators (now Kit)",alternatives:["Mailchimp","Klaviyo","Brevo"]},
